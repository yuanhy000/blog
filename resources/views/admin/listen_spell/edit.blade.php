...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/listen_spell/'.$field->ls_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>目标单词：</th>
                    <td>
                        <input type="text" name="ls_name" value="{{$field->ls_name}}">
                    </td>
                </tr>
                <tr>
                    <th>听音：</th>
                    <td>
                        <input type="text" size="50" name="ls_pro" value="{{$field->ls_pro}}">
