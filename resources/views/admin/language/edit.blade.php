...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/language/'.$field->lan_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>正确答案：</th>
                    <td>
                        <input type="text" name="lan_right" value="{{$field->lan_right}}">
                    </td>
                </tr>
                <tr>
                    <th>错误答案1：</th>
                    <td>
                        <input type="text" name="lan_error1" value="{{$field->lan_error1}}">
                    </td>
                </tr>
                <tr>
                    <th>错误答案2：</th>
                    <td>
                        <input type="text" name="lan_error2" value="{{$field->lan_error2}}">
                    </td>
                </tr>
                ...
                <tr>
                    <th>训练图片：</th>
                    <td>
                        <input type="text" size="50" name="lan_thumb" value="{{$field->lan_thumb}}">
