...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/textbook/'.$field->text_id)}}" method="post">
            ...
            <table class="add_tab">
                        ...
                        <select name="cate_id">
                            @foreach($data as $d)
                                <option value="{{$d->cate_id}}"
                                        @if($d->cate_id == $field->cate_id) selected @endif > <!--默认选中-->
                                    {{$d->_cate_name}}</option>
                            @endforeach
                        </select>
                    </td>
                ...
                <tr>
                    <th>课本名称：</th>
                    <td>
                        <input type="text"  name="text_name" value="{{$field->text_name}}">
                    </td>
                </tr>
                <tr>
                    <th>备注：</th>
                    <td>
                        <input type="text"  name="text_note" value="{{$field->text_note}}">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
                    <td>
                        <input type="text" size="50" name="text_thumb" value="{{$field->text_thumb}}">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img alt="" id="text_thumb_img" style="max-width: 350px; max-height:100px;"
                             src="/{{$field->text_thumb}}">
                    </td>
                </tr>
                <tr>
                    <th>排序：
                    ...
                    <td>
                        <input type="text" class="sm" name="text_order" value="{{$field->text_order}}">
                    </td>
                </tr>
