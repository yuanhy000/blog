...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/find_mean')}}" method="post">
            @csrf
            <table class="add_tab">
                <tbody>
                <tr>
                ...
                <tr>
                    <th>错误答案1：</th>
                    <td>
                        <input type="text" name="fm_error1">
                    </td>
                </tr>
                ...
                <tr>
                    <th>错误答案2：</th>
                    <td>
                        <input type="text" name="fm_error2">
                    </td>
                </tr>
                ...
                <tr>
                    <th>错误答案3：</th>
                    <td>
                        <input type="text" name="fm_error3">
                    </td>
                </tr>
