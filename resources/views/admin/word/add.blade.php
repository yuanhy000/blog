...
@section('content')
    ...
    <div class="crumb_warp">
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="{{url('admin/word')}}">单词管理</a>
        &raquo; 添加单词
    </div>
    <!--顶部导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/word')}}" method="post">
            @csrf
            <table class="add_tab">
                <tbody>
                <tr>
                ...
                <tr>
                    <th>音标：</th>
                    <td>
                        <input type="text" name="word_mark">
                    </td>
                </tr>
                ...
                <tr>
                    <th>词性释义：</th>
                    <td>
                        <input type="text" name="word_mean">
                    </td>
                </tr>
                <tr>
                    <th>格式：</th>
                ...
                <tr>
                    <th>单词读音：</th>
                    <td>
                        <input type="text" size="40" name="word_pro">
                ...
                <tr>
                    <th>例句_英语</th>
                    <td>
                        <textarea name="word_example_en" cols="30" rows="10"></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <th>例句_中文</th>
                    <td>
                        <textarea name="word_example_ch" cols="30" rows="10"></textarea>
                    </td>
                </tr>
