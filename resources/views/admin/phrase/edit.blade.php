...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/phrase/'.$field->ph_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>短语名称：</th>
                    <td>
                        <input type="text" name="ph_name" value="{{$field->ph_name}}">
                    </td>
                </tr>
                <tr>
                    <th>短语音标：</th>
                    <td>
                        <input type="text" name="ph_mark" value="{{$field->ph_mark}}">
                    </td>
                </tr>
                <tr>
                    <th>词性释义：</th>
                    <td>
                        <input type="text" name="ph_mean" value="{{$field->ph_mean}}">
                    </td>
                </tr>
                <tr>
                    <th>格式：</th>
                ...
                <tr>
                    <th>短语听力：</th>
                    <td>
                        <input type="text" size="50" name="ph_pro" value="{{$field->ph_pro}}">
                ...
                <tr>
                    <th>例句_英语</th>
                    <td>
                        <textarea name="ph_example_en" cols="30" rows="10">{{$field->ph_example_en}}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <th>例句_中文</th>
                    <td>
                        <textarea name="ph_example_ch" cols="30" rows="10">{{$field->ph_example_ch}}</textarea>
                    </td>
                </tr>
