...
<section>
    <div class="container" id="con_bottom2" style="margin-left: 0px;">
        <div>
            <h3 class="fm_name">{{$total[$id]->fm_name}}</h3>
        </div>
        <div>
            @if(session('right')==0)
                <a href="javascript:" target="_top" class="btn btn-primary" id="chose2" role="button"
                   onclick="check(1)">{{$total[$id]->fm_right}}</a>
                <a href="javascript:" target="_top" class="btn btn-primary" id="chose2" role="button"
                   onclick="check(0)">{{$total[$id]->fm_error1}}</a>
                <a href="javascript:" target="_top" class="btn btn-primary" id="chose2" role="button"
                   onclick="check(0)">{{$total[$id]->fm_error2}}</a>
                <a href="javascript:" target="_top" class="btn btn-primary" id="chose2" role="button"
                   onclick="check(0)">{{$total[$id]->fm_error3}}</a>
