...
<section id="Topic">
    <div class="container">
        ...
        <div class="col-md-12">
            <?php $i = 1;?>
            @foreach($topic as $t)
                <a  href="{{url('language_all/'.$t->top_id.'_'. $top_lan[$i]["lan_id"])}}"  class="btn btn-primary" id="topic" role="button"
...
<section>
    <div class="col-md-12" style="padding: 0;">
        <div class="container" style="padding: 0;">
            <div class="col-md-6">
                <a href="{{url('word/'.$get_text_id["text_id"])}}" target="_top" class="btn btn-primary"
                   id="read_all"
                   role="button">返回列表</a>
            </div>
            <div class="col-md-6">
                <a href="{{url('/language_conf')}}" target="_top" class="btn btn-primary"
                   id="read_all"
                   role="button">设置教材</a>
            </div>
        </div>
